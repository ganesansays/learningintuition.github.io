---
title: Linear Discriminant Analysis Intuition
comments: true
# other options
---
...
Download the full csv file [here](/assets/discriminantAnalysis/data/DiscriWinston.csv).
...
![alt text](/assets/discriminantAnalysis/image/IncomeBySubscriber.png)
...
![alt text](/assets/discriminantAnalysis/image/InvestmentAmountBySubscriber.png)
...
![alt text](/assets/discriminantAnalysis/image/IncomeBySubscriberDensity.png)

Density plots of investment amount does not have a overlap (11.4%) as big as income. 

![alt text](/assets/discriminantAnalysis/image/InestmentAmtBySubscriberDensity.png)
...
![alt text](/assets/discriminantAnalysis/image/ScatterPlotIncomeInvestment.png)
...
![alt text](/assets/discriminantAnalysis/image/ZScoreDensity.png)
...
s.src = 'https://learningintuition.disqus.com/embed.js';
